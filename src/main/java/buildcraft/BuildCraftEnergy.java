...
public class BuildCraftEnergy extends BuildCraftMod {
    ...
    public void preInit(FMLPreInitializationEvent evt) {
        ...
        int oilDesertBiomeId = BuildCraftCore.mainConfigManager
                .register(
                        "worldgen.biomes",
                        "biomeOilDesert",
                ...
                .getInt();
        int oilOceanBiomeId = BuildCraftCore.mainConfigManager
                .register(
                        "worldgen.biomes",
                        "biomeOilOcean",
        ...
        BuildCraftCore.mainConfigManager.register(
                "worldgen.spawnOilSprings", true, "Should I spawn oil springs?", ConfigManager.RestartRequirement.GAME);
        BuildCraftCore.mainConfigManager.register(
        ...
        double fuelOilMultiplier = BuildCraftCore.mainConfigManager
                .register(
                        "general",
                        "fuel.oil.combustion",
                        1.0F,
                        ...
                        RestartRequirement.GAME)
                .getDouble();
        double fuelFuelMultiplier = BuildCraftCore.mainConfigManager
                .register(
                        "general",
        ...
        int fuelOilEnergyOutput = BuildCraftCore.mainConfigManager
                .register(
                        "general",
                        ...
                        RestartRequirement.GAME)
                .getInt();
        int fuelFuelEnergyOutput = BuildCraftCore.mainConfigManager
                .register(
                        "general",
        ...
        if (oilDesertBiomeId > 0) {
            if (oilDesertBiomeId >= biomeGenArray.length || biomeGenArray[oilDesertBiomeId] != null) {
                ...
                BuildCraftCore.mainConfiguration
                        .get("worldgen.biomes", "biomeOilDesert", oilDesertBiomeId)
        ...
        if (oilOceanBiomeId > 0) {
            if (oilOceanBiomeId >= biomeGenArray.length || biomeGenArray[oilOceanBiomeId] != null) {
                ...
                // save changes to config file
                BuildCraftCore.mainConfiguration
                        .get("worldgen.biomes", "biomeOilOcean", oilOceanBiomeId)
                        .set(oilOceanBiomeId);
                BuildCraftCore.mainConfiguration.save();
            }
        ...
        if (!FluidRegistry.isFluidRegistered("redplasma")) {
            buildcraftFluidRedPlasma =
                    new Fluid("redplasma").setDensity(10000).setViscosity(10000).setLuminosity(30);
        ...
        if (blockOil != null) {
            spawnOilSprings = BuildCraftCore.mainConfigManager
                    .get("worldgen.spawnOilSprings")
                    .getBoolean(true);
        ...
        if (fluidFuel.getBlock() == null) {
            blockFuel = new BlockBuildCraftFluid(fluidFuel, Material.water, MapColor.yellowColor)
                    .setFlammable(true)
                    .setFlammability(5)
        ...
        BuildcraftRecipeRegistry.refinery.addRecipe(
                "buildcraft:fuel", new FluidStack(fluidOil, 1), new FluidStack(fluidFuel, 1), 120, 1);
        ...
        BuildcraftFuelRegistry.coolant.addSolidCoolant(
                StackKey.stack(Blocks.ice), StackKey.fluid(FluidRegistry.WATER), 1.5f);
        BuildcraftFuelRegistry.coolant.addSolidCoolant(
                StackKey.stack(Blocks.packed_ice), StackKey.fluid(FluidRegistry.WATER), 2.0f);

        BuildCraftCore.engineBlock.registerTile(
                TileEngineStone.class, 1, "tile.engineStone", "buildcraftenergy:engineStone");
        BuildCraftCore.engineBlock.registerTile(
                TileEngineIron.class, 2, "tile.engineIron", "buildcraftenergy:engineIron");
        BuildCraftCore.engineBlock.registerTile(
                TileEngineCreative.class, 3, "tile.engineCreative", "buildcraftenergy:engineCreative");
    ...
    public void reloadConfig(ConfigManager.RestartRequirement restartType) {
        if (restartType == ConfigManager.RestartRequirement.GAME) {
            ...
            oilWellScalar = BuildCraftCore.mainConfigManager
                    .get("worldgen.oilWellGenerationRate")
                    .getDouble();

            if (blockOil instanceof BlockBuildCraftFluid) {
                canOilBurn = BuildCraftCore.mainConfigManager
                        .get("general.oilCanBurn")
                        .getBoolean();
                isOilDense = BuildCraftCore.mainConfigManager
                        .get("general.oilIsDense")
                        .getBoolean();
    ...
    public void init(FMLInitializationEvent evt) {
        ...
        engineAchievement2 = BuildCraftCore.achievementManager.registerAchievement(new Achievement(
        ...
        engineAchievement3 = BuildCraftCore.achievementManager.registerAchievement(new Achievement(
    ...
    public void textureHook(TextureStitchEvent.Post event) {
        if (event.map.getTextureType() == 0) {
            ...
            if (buildcraftFluidFuel != null) {
                buildcraftFluidFuel.setIcons(
                        blockFuel.getBlockTextureFromSide(1), blockFuel.getBlockTextureFromSide(2));
            }
            if (buildcraftFluidRedPlasma != null) {
                buildcraftFluidRedPlasma.setIcons(
                        blockRedPlasma.getBlockTextureFromSide(1), blockRedPlasma.getBlockTextureFromSide(2));
            }
        }
    }
    ...
    public void whiteListAppliedEnergetics(FMLInitializationEvent event) {
        FMLInterModComms.sendMessage(
                "appliedenergistics2", "whitelist-spatial", TileEngineBase.class.getCanonicalName());
    }
